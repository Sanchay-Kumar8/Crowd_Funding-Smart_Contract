...
contract CrowdFunding{
    ...
    mapping(uint => Request) public requests; // mapped uint to Request struct 0 -> Request1, 1-> Request2...
    ...
    function makePayment(uint _requestNo) public onlyManager{
        ...
        require(thisRequest.noOfVoters > noOfContributors/2, "Majority does not support the transaction");
